...
const createProduct = {
  body: Joi.object().keys({
    ...
    purity: Joi.string().custom(objectId).required(),
...
const updateProduct = {
  ...
  body: Joi.object().keys({
    ...
    purity: Joi.string().custom(objectId),
    ...
    mainImage: Joi.string().custom(objectId),
    isSpecial: Joi.boolean(),
    special_cat_id: Joi.alternatives().conditional('isSpecial', { is: true, then: Joi.string().custom(objectId) }),
  }),
};

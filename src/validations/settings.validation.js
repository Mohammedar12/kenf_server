...
const getShippingList = {
  query: Joi.object().keys({
    ...
    sort: Joi.string().valid('createdAt','-createdAt','company','-company','price','-price','time','-time'),
  }),
};
/************************************************ */
...
const getItemSizeList = {
  query: Joi.object().keys({
    limit: Joi.number().integer().min(5).max(100),
    page: Joi.number().integer().min(1),
    sort: Joi.string().valid('createdAt','-createdAt','name_en','-name_en','name_ar','-name_ar','unit','-unit'),
  }),
};
/************************************************ */
...
const getItemGroupList = {
  query: Joi.object().keys({
    limit: Joi.number().integer().min(5).max(100),
    page: Joi.number().integer().min(1),
    sort: Joi.string().valid('createdAt','-createdAt','name_en','-name_en','name_ar','-name_ar','abbreviation','-abbreviation'),
  }),
};
/************************************************ */
...
const getItemCategoryList = {
  query: Joi.object().keys({
    ...
    limit: Joi.number().integer().min(5).max(100),
    page: Joi.number().integer().min(1),
    sort: Joi.string().valid('createdAt','-createdAt','name_en','-name_en','name_ar','-name_ar','kenf_collection','-kenf_collection','abbreviation','-abbreviation','isKenf','-isKenf'),
  }),
};
...
const getPurityList = {
  query: Joi.object().keys({
    limit: Joi.number().integer().min(5).max(100),
    page: Joi.number().integer().min(1),
    sort: Joi.string().valid('createdAt','-createdAt','name_en','-name_en','name_ar','-name_ar'),
  }),
};
/************************************************ */

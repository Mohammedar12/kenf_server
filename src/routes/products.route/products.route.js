...
router
  .route("/")
  .get(
    validate(productValidation.getProductListApp),
    productController.getProductListApp
  );
router
  .route("/find")
  .get(
    auth("admin", true),
    validate(productValidation.findProducts),
...
router
  ...
  .get(
    auth("admin"),
    validate(productValidation.getProductListAdmin),
    productController.getProductListAdmin
  );
...
router
  ...
  .get(
    auth("admin"),
    validate(productValidation.getAdminProduct),
...
router
  ...
  .get(
    ...
    productController.getProductApp
  )
  .delete(
    auth("admin"),
    validate(productValidation.productId),
